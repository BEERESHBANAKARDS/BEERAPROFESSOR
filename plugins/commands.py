...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton("📢 𝚄𝙿𝙳𝙰𝚃𝙴𝚂 📢", url="https://t.me/join_movies_adda")
            ],[      
        ...
        m=await message.reply_sticker("CAACAgIAAxkBAAM6Zq8p_JC4U6A-xUwwv8gKuLWJAAGIAAJODgACsLsZSwj6d7WIG05EHgQ")
